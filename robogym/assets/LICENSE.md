# Lego
The lego duplo block [models](xmls/holdouts/lego) are based on a MuJoCo model from the [dm_control](https://github.com/deepmind/dm_control/) package that is under Apache License, Version 2.0.
